...
function paginateTable(tbodyId, paginationId, selectorId, initialRows = 10) {
  ...
  let rowsPerPage = initialRows, currentPage = 1;
  ...
  function showPage(page) {
    ...
    visibleRows.slice((currentPage - 1) * rowsPerPage, currentPage * rowsPerPage).forEach((row, i) => {
      row.style.display = "";
      const numCell = row.querySelector(".row-number");
      if (numCell) numCell.textContent = (currentPage - 1) * rowsPerPage + i + 1;
    });
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      } else if ((i === currentPage - 2 && currentPage - 3 > 1) || (i === currentPage + 2 && currentPage + 3 < totalPages)) {
  ...
  function addSearchFilter(inputId, searchableCols = [2, 3, 6]) {
    ...
    input.oninput = () => {
      ...
      Array.from(tbody.rows).forEach(row => {
        const show = searchableCols.some(i => {
...
document.addEventListener("DOMContentLoaded", () => {
  paginateTable("akanTableBody", "akanPagination", "akanRowsPerPage", 10)("searchAkanMagang");
  paginateTable("sedangTableBody", "sedangPagination", "sedangRowsPerPage", 10)("searchSedangMagang");
  paginateTable("selesaiTableBody", "selesaiPagination", "selesaiRowsPerPage", 10)("searchSelesaiMagang");
  paginateTable("batalTableBody", "batalPagination", "batalRowsPerPage", 10)("searchBatalMagang");
});
